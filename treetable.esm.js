...
function Node (row, tree, settings) {
  ...
  this.tree = tree
  this.row = row
  this.id = this.row.data(this.settings.nodeIdAttr) // TODO Ensure id/parentId is always a string (not int)

  var parentId = this.row.data(this.settings.parentIdAttr) // TODO Move this to a setParentId function?
  if (parentId) {
...
Node.prototype.render = function () {
  ...
  if (settings.expandable && this.isBranchNode()) {
    ...
    handler = function (e) {
      that.tree[that.row.data(settings.nodeIdAttr)].toggle()
